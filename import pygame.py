...
def display_msg(msg,colour):
    ...
    add_caption.blit(mssg, [box_len/6 , box_height])
...
def game_start():
    ...
    foody_pos = round(random.randrange(0,box_height)) 

    while not game_over:

        while game_close == True:
            add_caption.fill(colour=colour_6)
...
# youtube länk https://www.youtube.com/watch?v=SUtHKHwUKT4
